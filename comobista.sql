...
--
-- Host: localhost:3306
-- Generation Time: Feb 08, 2024 at 09:05 AM
...
CREATE TABLE `activity` (
  ...
  `activity_picrole` varchar(50) NOT NULL,
  `activity_name` varchar(200) NOT NULL,
  `activity_date` date NOT NULL,
  `activity_time` time(6) NOT NULL,
  `activity_venue` varchar(100) NOT NULL,
  `club_id` int NOT NULL,
  `activity_participant` varchar(5) NOT NULL,
  `activity_vip` varchar(50) NOT NULL,
  `activity_cost` varchar(10) NOT NULL,
...
CREATE TABLE `contact` (
  ...
  `contact_studid` text,
  `contact_fakulti` varchar(100) NOT NULL,
  `contact_group` varchar(10) NOT NULL,
...
(5, 'Humaira', 'Rosli', 'humaira@gmail.com', 'female', '', ''),
(6, 'Randy', 'San', 'Randy@gmail.com', 'male', 'Ran12', 'ran12'),
(7, 'SHARIFAH', 'ALI', 'cahayamata2201@gmail.com', 'female', 'sharifah', '123'),
(8, 'Nur Alya', 'Rosli', 'Alya@gmail.com', 'female', 'alyarosli', '123');
