...
<head>
  ...
  <title>Community of Bachelor in Statistics Club</title>
</head>
...
<body style="background-color:#ca8b86 ">
  ...
  <div class="container">
    ...
    ?>
	<p align="center"><h3>Contact Us for Community of Bachelor in Statistics Club (COMOBISTA)></p>
      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td><?php echo $row["contact_fakulti"] ?></td>
